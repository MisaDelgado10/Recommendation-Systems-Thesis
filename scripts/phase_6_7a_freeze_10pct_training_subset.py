...
# =============================================================================
# Phase 6.7a — 10% reduced-supervision experimental protocol
# =============================================================================
...
SELECTION_MANIFEST_PATH = (
    OUT_DIR
    / "positive_selection_manifest_10pct.parquet"
)
...
def build_subset(
    ...
    # =========================================================================
    # Exact floor(10%) positive-event target.
    # =========================================================================
    ...
    require(
        ...
        (
            "10% target is too small to preserve "
