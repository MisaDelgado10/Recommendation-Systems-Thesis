...
POSITIVE_PATH = Path(
    ...
    "10pct/positive_order_10pct.parquet"
)
...
OUT_DIR = Path(
    ...
    "phase_6_7c_10pct_bounded_trainer"
)
...
def save_probe_checkpoint(
    *,
    ...
    payload = {
        "schema_version": (
            "ITRS_PHASE6_10PCT_CHECKPOINT_V1"
        ),
...
def main():
    ...
    q5a = json.loads(
        PHASE6_7B_CONTRACT_PATH.read_text(
            encoding="utf-8"
        )
    )
    ...
    print(
        "Phase 6.7a subset gate:             PASS"
    )
    print(
        "Phase 6.7b epoch-stream gate:      PASS"
    )
    ...
    contract = {
        ...
        "status": (
            "PASS_BOUNDED_10PCT_TRAINER_INTEGRATION"
        ),
    ...
    print(
        "PHASE 6.7c: PASS / "
        "10% TRAINER INTEGRATION QUALIFIED"
    )
