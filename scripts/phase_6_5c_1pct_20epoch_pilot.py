...
REDUCED_RUNTIME_PATH = Path(
    "scripts/"
    "phase_6_5b_1pct_bounded_trainer_integration.py"
)
...
POSITIVE_PATH = Path(
    ...
    "reduced_training/1pct/"
    "positive_order_1pct.parquet"
)
...
FINAL_CONTRACT_PATH = Path(
    "data/experimental/phase_6/contracts/"
    "phase_6_5c_1pct_20epoch_pilot_result.json"
)
...
def checkpoint_payload(
    *,
    ...
    return {
        "schema_version": (
            "ITRS_PHASE6_1PCT_PRODUCTION_PILOT_V1"
        ),
...
def prerequisite_gate(
    *,
    ...
    print(
        "Phase 6.4 subset:                      PASS"
    )
    print(
        "Phase 6.5a 20 epoch streams:           PASS"
    )
    print(
        "Phase 6.5b bounded integration:        PASS"
    )
    print(
        "1% positive SHA:                       PASS"
    )
...
def main():
    ...
    validation_preflight = (
        load_module(
            ...
            "_phase6_5c_validation_preflight",
        )
    )
    ...
    while not state[
        ...
        if (
            ...
            print(
                "Resume command:                "
                "python scripts/"
                "phase_6_5c_1pct_20epoch_pilot.py "
                "--resume"
            )
    ...
    result_contract = {
        ...
        "test_boundary": {
            ...
            "reason": (
                "1% is a model-selection/data-efficiency "
