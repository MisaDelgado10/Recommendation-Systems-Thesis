#!/usr/bin/env python3
"""
Phase 5.4.8b — Packed-Embedding Apple MPS Numerical Equivalence + Feasibility Audit
...
EXPECTED_CANONICAL_EXECUTOR_AST_SHA256 = (
    "36238d12ea7220cb52a41fd787bdec4e"
    "c92086b43cd8709f42211e824cf51a86"
)

EXPECTED_LEAN_EXECUTOR_AST_SHA256 = (
    "c21a49d24c4f92c4814588f3cb315dd"
    "2e70598ec700c45e43a2afa596d6243b6"
)
...
def main() -> None:
    ...
    checks = [
        ...
        (
            "corrected_canonical_ast_sha_exact",
            executor_metadata[
                "canonical_executor_ast_sha256"
            ]
            == EXPECTED_CANONICAL_EXECUTOR_AST_SHA256,
