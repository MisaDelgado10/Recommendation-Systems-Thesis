...
EXPECTED_SUBSET_SHA = (
    "0eba539a582c59087722b8873c61bb63"
    "80d6133970cd4b2d2f2a6cf83f1e1c63"
)
...
REDUCED_RUNTIME_PATH = Path(
    "scripts/"
    "phase_6_6c_5pct_bounded_trainer_integration.py"
)
...
PHASE6_6A_CONTRACT_PATH = Path(
    "data/experimental/phase_6/contracts/"
    "phase_6_6a_reduced_training_5pct_contract.json"
)

PHASE6_6B_CONTRACT_PATH = Path(
    "data/experimental/phase_6/contracts/"
    "phase_6_6b_5pct_filtered_epoch_stream_contract.json"
)

PHASE6_6C_CONTRACT_PATH = Path(
    "data/experimental/phase_6/contracts/"
    "phase_6_6c_5pct_bounded_trainer_integration.json"
)
...
FINAL_CONTRACT_PATH = Path(
    "data/experimental/phase_6/contracts/"
    "phase_6_6d_5pct_20epoch_pilot_result.json"
)
...
def progress_payload(
    *,
    ...
    return {
        "phase": "6.6d",
        "experiment": (
            "5PCT_REDUCED_SUPERVISION_PILOT"
        ),
...
def checkpoint_payload(
    *,
    ...
    return {
        "schema_version": (
            "ITRS_PHASE6_5PCT_PRODUCTION_PILOT_V1"
        ),
...
def prerequisite_gate(
    *,
    ...
    banner(
        "PHASE 6.6d PREREQUISITE GATE"
    )

    for path in (
        PHASE6_2_CONTRACT_PATH,
        PHASE6_6A_CONTRACT_PATH,
        PHASE6_6B_CONTRACT_PATH,
        PHASE6_6C_CONTRACT_PATH,
        POSITIVE_PATH,
        STREAM_REGISTRY_PATH,
    ...
    print(
        "Phase 6.6a subset:                      PASS"
    )
    print(
        "Phase 6.6b 20 epoch streams:           PASS"
    )
    print(
        "Phase 6.6c bounded integration:        PASS"
    )
    print(
        "5% positive SHA:                       PASS"
    )
...
def main():
    ...
    validation_preflight = (
        load_module(
            ...
            "_phase6_6d_validation_preflight",
        )
    )
    ...
    while not state[
        ...
        if (
            ...
            print(
                "Resume command:                "
                "python scripts/"
                "phase_6_6d_5pct_20epoch_pilot.py "
                "--resume"
            )
    ...
    result_contract = {
        ...
        "test_boundary": {
            ...
            "reason": (
                "5% is a model-selection/data-efficiency "
