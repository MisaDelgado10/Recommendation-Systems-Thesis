#!/usr/bin/env python3
"""
Phase 5.3.7 — Full Reproduction Integrity Closure Audit
...
EXPECTED_PHASE2_ROWS = 1_208_051
...
def main() -> None:
    ...
    try:
        ...
        null_segment_count = int(
            segment_numeric.isna().sum()
        )
        ...
        record(
            section="Phase 2",
            check="post-endpoint rows",
            passed=(
                null_segment_count
                == EXPECTED_POST_ENDPOINT_ROWS
            ),
            actual=null_segment_count,
    ...
    banner(
        "WRITE PHASE-5.3.7 CLOSURE OUTPUTS"
    )
