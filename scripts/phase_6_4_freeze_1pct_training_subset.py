...
# =============================================================================
# Phase 6.4 — 1% reduced-supervision experimental protocol
# =============================================================================
...
SELECTION_MANIFEST_PATH = (
    OUT_DIR
    / "positive_selection_manifest_1pct.parquet"
)
...
def build_subset(
    ...
    # =========================================================================
    # Exact floor(1%) positive-event target.
    # =========================================================================
    ...
    require(
        ...
        (
            "1% target is too small to preserve "
...
def main():
    ...
    banner(
        "PHASE 6.4 — FREEZE 1% REDUCED-SUPERVISION "
        "TRAINING EXPERIMENT"
    )
    ...
    banner(
        "PHASE 6.4 — 1% PILOT SUBSET RESULT"
    )
