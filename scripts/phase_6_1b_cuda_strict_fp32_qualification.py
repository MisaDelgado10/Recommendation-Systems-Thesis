...
OUT_DIR = Path(
    ...
    "phase_6_1b_cuda_strict_fp32"
)

CONTRACT_PATH = Path(
    "data/experimental/phase_6/contracts/"
    "phase_6_1b_cuda_strict_fp32_qualification.json"
)
...
def main() -> None:
    ...
    banner(
        "PHASE 6.1b — MAC CANONICAL → RTX 4090 CUDA "
    ...
    # =====================================================================
    # Phase 6.1b — strict CUDA numerical mode
    # =====================================================================
    # No scientific semantics change. These settings only constrain the
    # floating-point/kernel implementation used by the CUDA backend.
    ...
    print("CUDA strict numerical mode:")
    ...
    contract = {
        ...
        "candidate_runtime": (
            "D_BOTH_SPARSE_CUDA_STRICT_FP32"
        ),
        "reference_runtime": (
    ...
    banner(
        "PHASE 6.1b STRICT-FP32 CUDA QUALIFICATION RESULT"
    )
